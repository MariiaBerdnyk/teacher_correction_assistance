...
from benchmarks.benchmark_ocr.benchmark_image2text import monitor_gpu_memory, copy_images_to_directory
from front.server import extract_text, syntax_check, grammar_check, set_device
